...
class Agent:
  ...
  def compute_policy(self):
    ...
    if ( all_piles[0][0] + all_piles[1][0] ) % 5 != 0:
      action_choices.append(self.add_left_left)
    elif ( all_piles[0][0] + all_piles[1][1] ) % 5 != 0:
      action_choices.append(self.add_left_right)

    elif ( all_piles[0][1] + all_piles[1][0] ) % 5 != 0:
      action_choices.append(self.add_right_left)
    elif ( all_piles[0][1] + all_piles[1][1] ) % 5 != 0:
      action_choices.append(self.add_right_right)
  ...
  @PCCA_Function('random move a')
  def random_move_a(self):
    self._piles.set(self._world.update_opponent_piles(self, (0,0)))

  @PCCA_Function('random move b')
  def random_move_b(self):
