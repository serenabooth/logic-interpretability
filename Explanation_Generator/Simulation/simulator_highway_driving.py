...
class Agent:
  ...
  def compute_policy(self):
    ...
    if (exit_sign == 42 and car_front == 0 and car_right == 1 and car_behind == 1) or \
       (exit_sign != 42 and car_front == 0):
    ...
    elif (exit_sign != 42 and car_left == 0 and car_front == 1) or \
       (exit_sign != 42 and car_left == 0 and car_behind == 1):
    ...
    elif (exit_sign == 42 and car_right == 0) or\
       (exit_sign != 42 and car_right == 0 and car_left == 1 and car_front == 1):
